...
export default function NFTMintingNotification({
  isVisible,
  onClose,
  tokenId,
  transactionHash,
  postCid
}: NFTMintingNotificationProps) {
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-1 text-xs text-purple-200">
              ...
              {transactionHash && (
                <a
                  href={`https://explorer.ripple.com/transactions/${transactionHash}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-1 text-gold hover:text-yellow-300 transition-colors"
                >
